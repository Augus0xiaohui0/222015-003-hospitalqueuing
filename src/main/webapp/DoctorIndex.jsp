...
if (request.getAttribute("fromlogin")!=null) {
	if ((boolean) request.getAttribute("fromlogin")) {
...
<li>
<a href="DoctorServlet?action=classify&cid=1" >普通<span class="timer count-title" data-to="${requestScope.stats[1]}" data-speed="40" style="color:#40404070;">0</span></a>
</li>
<li>
<a href="DoctorServlet?action=classify&cid=2" >优先<span class="timer count-title" data-to="${requestScope.stats[2]}" data-speed="40" style="color:#40404070;">0</span></a>
</li>
<li>
<a href="DoctorServlet?action=classify&cid=3" >急诊<span class="timer count-title" data-to="${requestScope.stats[3]}" data-speed="40" style="color:#40404070;">0</span></a>
</li>
<li>
<a href="DoctorServlet?action=classify&cid=4" >绿色通道<span class="timer count-title" data-to="${requestScope.stats[4]}" data-speed="40" style="color:#40404070;">0</span></a>
</li>
<li>
<a href="DoctorServlet?action=classify&cid=5" >诊结<span class="timer count-title" data-to="${requestScope.stats[5]}" data-speed="40" style="color:#40404070;">0</span></a>
</li>
<li>
<a href="DoctorServlet?action=classify&cid=6" >暂停<span class="timer count-title" data-to="${requestScope.stats[6]}" data-speed="40" style="color:#40404070;">0</span></a>
</li>
<li class="account">
<a href="" id="acc">医生</a>
<ul id="acmenu">
