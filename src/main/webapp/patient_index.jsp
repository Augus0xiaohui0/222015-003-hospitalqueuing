...
if (cookies!=null) {
    for (Cookie cookie : cookies) {
        if (cookie.getName().equals("pnum")) {
            pnum = cookie.getValue();
        }
        if (cookie.getName().equals("ppsd")) {
            ppsd = cookie.getValue();
        }
    }
}
	...
	<section class="doctorsBase BaseMark">
		...
		if (request.getAttribute("pmenu")!=null) {
			...
			case "5"://就诊单
				...
				<span>预约编号：</span><input class = "NewBase_Y1" type="text" name="anum" value="${requestScope.latestAppo.anum }" readonly/><br/>
				<span>患者编号：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestAppo.pname }" readonly/><br/>
				<span>所在科室：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestAppo.ddepartment }" readonly/><br/>
				<span>医生编号：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestAppo.dname }" readonly/><br/>
				<span>预约时间：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestAppo.yytime }" readonly/><br/>
				<span>就诊时间：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestAppo.jztime }" readonly/><br/>
				<span>就诊诊室：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestAppo.dcon }" readonly/><br/>
				<span>就诊状态：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestAppo.astate }" readonly/><br/>
				<span>队列类型：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestAppo.atype }" readonly/><br/>
				<button class = "NewBase_Y2">确认完成</button>
				</form>
				</div>
				<%
				break;
			case "6"://检查单
				...
				<span>医技检查编号：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestMTB.mtenum }" readonly/><br/>
				<span>患者编号：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestMTB.pnum }" readonly/><br/>
				<span>医技项目编号：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestMTB.mtnum }" readonly/><br/>
				<span>医技检查时间：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestMTB.mtetime }" readonly/><br/>
				<span>医技检查状态：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestMTB.mtstate }" readonly/><br/>
				<button class = "NewBase_Y2">确认完成</button>
				</form>
				</div>
				<%
			...
			case "7"://取药单
				...
				<input type="hidden" name="pnum" value="<%=pnum%>"/>
				<span>取药编号：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestTMB.tmnum }" readonly/><br/>
				<span>患者编号：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestTMB.pnum }" readonly/><br/>
				<span>药品编号：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestTMB.drnum }" readonly/><br/>
				<span>取药数量：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestTMB.drquantity }" readonly/><br/>
				<span>取药状态：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestTMB.tmstate }" readonly/><br/>
				<button class = "NewBase_Y2">确认完成</button>
				</form>
				</div>
				<%
			...
			case "8"://挂号
				...
				<span>患者编号：</span><input class = "NewBase_Y1" type="text" name = "pnum" value="<%=pnum %>" /><br/>
				<span>所在科室：</span><input  class = "NewsBase_Y1" type="text" name = "ddepartment" value="" /><br/>
				<span>医生编号：</span><input  class = "NewsBase_Y1" type="text" name = "dnum" value="${sessionScope.selected }" /><br/>
				<span>预约时间：</span><input  class = "NewsBase_Y1"type="text" name = "yytime" value="" /><br/>
				<span>就诊时间：</span><input  class = "NewsBase_Y1" type="text" name = "jztime" value="" /><br/>
				<span>就诊诊室：</span><input  class = "NewsBase_Y1" type="text" name = "docn" value="" /><br/>
				<input type="hidden" name = "astate" value="1" /><br/>
				<input type="hidden" name = "atype" value="1" /><br/>
				<button class = "NewBase_Y2">挂号</button>
				</form>
				</div>
				<%
				break;
			case "9"://退号
				...
				<span>就诊状态：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestAppo.astate }" readonly/><br/>
				<span>队列类型：</span><input class = "NewBase_Y1" type="text" value="${requestScope.latestAppo.atype }" readonly/><br/>
				<button class = "NewBase_Y2">确认退号</button>
				</form>
				</div>
				<%
				break;
